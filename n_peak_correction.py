...
for index,dist in enumerate(dists):
    ...
    if gauss == True:
        ...
        gmodel.set_param_hint('sigma2', value=p0[6], min=bounds[6][0], max=bounds[6][1])
        ...
        gmodel.set_param_hint('sigma3', value=p0[10], min=bounds[10][0], max=bounds[10][1])
        ...
        gmodel.set_param_hint('sigma4', value=p0[14], min=bounds[14][0], max=bounds[14][1])
        ...
        gmodel.set_param_hint('sigma5', value=p0[18], min=bounds[18][0], max=bounds[18][1])
        ...
        gmodel.set_param_hint('sigma6', value=p0[22], min=bounds[22][0], max=bounds[22][1])
...
#        gmodel.set_param_hint('a', value=1000, min=0, max=50000)
#        gmodel.set_param_hint('mu', value=298, min=289, max=300)
#        gmodel.set_param_hint('sigma', value=1.0, min=1, max=2)
#        gmodel.set_param_hint('gamma', value=1, min=-20, max=20)
#        gmodel.set_param_hint('m', value=-0.1, min=-0.4, max=0)
#        gmodel.set_param_hint('b', value=200, min=0, max=300)
#        params = gmodel.make_params()
#        res = gmodel.fit(n_tof_hist, params, x=n_bin_centers, nan_policy='omit')
#        print '\nFitting neutron peak with LMFIT'
#        print res.message
...
#        plt.plot(n_bin_centers,n_tof_hist)
#        plt.plot(n_bin_centers,res.best_fit)
#        plt.plot(n_bin_centers,gaus_exp_convo(n_bin_centers,f['a'],f['mu'],f['sigma'],f['gamma'],f['m'],f['b']))
#        plt.ylim(0,4e4)
